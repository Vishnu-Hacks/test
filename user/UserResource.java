...
import com.ctc.myct.search.rest.SearchApplication;
...
public class UserResource {
    SearchApplication _app;

    public UserResource(SearchApplication app) {
        this._app = app;
    }
    ...
    public MyCTUser getCurrentUser(@Context HttpServletRequest request) {
